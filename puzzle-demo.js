...
export const PUZZLE = {
  ...
  words: [
    ...
    },
    {
      ...
      row: 10, col: 4,
      clue: 'What developers claim they do but pen testers beg to differ, short name'
    },
    {
      number: 10,
      direction: 'across',
      ...
      row: 12, col: 4,
      clue: 'The measure of "does it matter?"; may end up in "we need to escalate this right now"'
    },
    {
      number: 12,
      direction: 'across',
      ...
      row: 19, col: 1,
      clue: 'A risk concept that is mentioned in every Town Hall at CBA these days'
    },
    ...
    },
    {
      ...
      row: 7, col: 13,
      clue: 'Not into acting, though the job description is suspiciously similar'
    },
    {
      number: 7,
      direction: 'down',
